// Quick test script for Digital Europe scraper - limits to 5 grants
const DigitalEuropeScraper = require('./digital_europe_scraper');
const config = require('../config/sources.json');

class TestDigitalEuropeScraper extends DigitalEuropeScraper {
  async scrape() {
...
const scraper = new TestDigitalEuropeScraper(config);
