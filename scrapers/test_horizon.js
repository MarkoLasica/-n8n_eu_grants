// Quick test script for Horizon Europe scraper - limits to 5 grants
const HorizonEuropeScraper = require('./horizon_europe_scraper');
const config = require('../config/sources.json');

class TestHorizonScraper extends HorizonEuropeScraper {
  async scrape() {
...
const scraper = new TestHorizonScraper(config);
