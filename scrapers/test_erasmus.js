// Quick test script for Erasmus scraper - limits to 5 grants
const ErasmusScraper = require('./erasmus_scraper');
const config = require('../config/sources.json');

class TestErasmusScraper extends ErasmusScraper {
  async scrape() {
...
const scraper = new TestErasmusScraper(config);
